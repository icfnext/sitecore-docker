...
This container holds the Sitecore xconnect collection search service running on port 443.

## Building the Container Search Locally
...
|`SOLR_CORE`              | Env Var | Yes | The url for the solr search service. |
